...
function EditBillModal({ setOpenEditBillModal, customerBill, listBilling, handleEdit }) {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            const response = await axios.put(`/billing/${customerBill.id}`,
                {
        ...
        <div className='container-register-bill-modal'>
            <form onSubmit={(e) => handleSubmit(e)} className='form-register-bill'>
                ...
                <div className='botoes-register-bill-modal'>
                    <button type='button' className='btn-cancelar' onClick={() => setOpenEditBillModal(false)}>Cancelar</button>
                    <button className='btn-aplicar'>Aplicar</button>
                </div>


                <img className='close-icon' src={close} alt='icon-close' onClick={() => setOpenEditBillModal(false)} />
